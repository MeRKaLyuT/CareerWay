            ...
            {isAuth ? (
              <Box sx={{width: "80%",}}>
                <Box>
                  ...
                  Понимание своих способностей, интересов и желаний — ключ к осознанному выбору будущего. 
                ...
                <Box sx={{ display: "flex", justifyContent: "center"}}>
                  <Button sx={{}}>Профориентационный тест</Button>
                </Box>
              </Box>
            ) : (
              <Box sx={{
                ...
                <Typography variant='h4' sx={{
                  ...
                  <Typography sx={{my:"2rem"}}>*После регистрации тебе станет доступен профориентационный тест*</Typography>
                <Button
                  variant="contained"
                  size="large"
                  sx={{
